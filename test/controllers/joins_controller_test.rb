...
class JoinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create join" do
    assert_difference('Join.count') do
      post joins_url, params: { join: { event_id: @join.event_id, qty: @join.qty, user_id: @join.user_id } }, as: :json
    end
  ...
  test "should update join" do
    patch join_url(@join), params: { join: { event_id: @join.event_id, qty: @join.qty, user_id: @join.user_id } }, as: :json
    assert_response 200
  end
